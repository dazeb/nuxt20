<template>
    <section
        class="pt-20 pb-32 bg-white tails-selected-element"
        contenteditable="true"
    >
        <div class="px-20 mx-auto max-w-7xl">
            <h2
                class="mb-1 text-3xl font-extrabold leading-tight text-gray-900"
            >
                Features
            </h2>
            <p class="mb-16 text-lg text-gray-500">
                Here is our list of our powerful and award-winning features.
            </p>
            <div
            ...
            >
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 lg:text-base">
                        Bundling functionality to help you build your
                        application with ease and sustainability.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 lg:text-base">
                        Take advantage of unlimited storage and data retrieval
                        from our global CDN data centers.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 lg:text-base">
                        Simple and configuration intregrations with your
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 lg:text-base">
                        Our tools and services have been crafted for maximum
