<template>
    <div
        class="bg-white pb-36 pt-36 dark:bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950"
    >
        <div
            class="max-w-3xl px-12 mx-auto space-y-8 text-left lg:px-0 md:text-center h-50"
        >
            <div
                class="max-w-3xl px-12 mx-auto space-y-8 text-left lg:px-0 md:text-center h-50"
            >
                <UBadge
                    label="Prices now start at just £5/month"
                    color="primary"
                    variant="solid"
                    size="md"
                ...
                />
                <h2
                    class="max-w-2xl mx-auto text-5xl font-bold text-gray-600 dark:text-gray-100 md:text-6xl"
                >
                ...
                <p
                    class="flex justify-center max-w-3xl space-y-5 text-lg text-gray-500 dark:text-white"
                >
