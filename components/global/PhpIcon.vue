<template>
    <div>
        ...
        >
            ...
            <path
                fill="#d2d2d2"
                d="M12.425 16.7a3.86 3.86 0 1 0-3.832-3.86a3.846 3.846 0 0 0 3.832 3.86Z"
            />
            <path
                fill="#232323"
                d="M12.425 14.834a1.992 1.992 0 1 0-1.978-1.992a1.985 1.985 0 0 0 1.978 1.992Z"
            />
        </svg>
    </div>
</template>
